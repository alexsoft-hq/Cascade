...
export const VIEWER_STRINGS = {
  en: {
    ...
    'chain.svg.dropped': '{n} link(s) are not drawn: the row each one comes from is in a list that was cut',
    ...
    // ---- Transactions tab ------------------------------------------------
    'summary.lead': 'The whole pack in a few boxes: which parts of the code reach which families of tables.',
    'summary.loading': 'walking every route in the pack…',
    'summary.rule.declared': 'Groups are handler packages cut to {n} segment(s), as the profile declares.',
    'summary.rule.code': 'Groups are where the handler code sits, below {prefix}, not modules anyone declared.',
    'summary.rule.path': 'Groups are route path segments below {prefix}.',
    ...
    'summary.group.sub': '{routes} route(s), {tables} table(s)',
    'summary.family.sub': '{tables} table(s)',
    'summary.others.groups': '{n} smaller group(s), {routes} route(s)',
    ...
    'compare.filter.count': '{shown} of {total} rows carry the text',
    ...
    'compare.cut': '{field}: {shown} of {total} rows are shown; the total is whole',
    'compare.summary': 'Summary',
    'compare.sum.content': 'Content',
    'compare.sum.content.v': '{added} node(s) added, {removed} removed, {changed} with a changed attribute',
    'compare.sum.relations': 'Relationships',
    'compare.sum.relations.v': '{added} edge(s) added, {removed} removed',
    'compare.sum.evidence': 'Evidence',
    'compare.sum.evidence.v': '{regraded} edge(s) changed grade, {changed} changed what the evidence says',
    'compare.sum.location': 'Source location only',
    'compare.sum.location.v': '{nodes} node(s) and {edges} edge(s) moved in the source and mean the same',
    ...
    'compare.empty.moved': 'Only source locations differ: {nodes} node(s) and {edges} edge(s) moved and mean the same',
    ...
    'compare.check.ends': 'Open each of the {n} endpoint(s) and {m} screen(s) above the change with Flow and read the chain under it.',
    ...
    'compare.check.content': 'Read the {n} changed attribute record(s) value by value: a column type, a transaction marker or a handler is a code change wherever it is used.',
    'compare.check.evidence': 'For the {n} edge(s) whose evidence changed, the relation is the same and what the engine read from the source is not: check the source it names.',
    'compare.check.regraded': '{n} edge(s) changed grade: the same relation is known with more or less certainty than before.',
    'compare.check.moved': '{n} record(s) moved in the source only: the graph means the same, and nothing above them is counted as touched. A moved statement or handler can still deserve a look in the file diff.',
