...
test('the web worker is English, carries no NUL byte, and the vendored parser is left alone', () => {
  ...
  assert.deepEqual(own, [
    ...
    'adapters/web/lib/imports.mjs', 'adapters/web/lib/navigation.mjs', 'adapters/web/lib/nexacro.mjs',
    'adapters/web/lib/routers.mjs', 'adapters/web/lib/templates.mjs', 'adapters/web/webfacts.mjs',
  ]);
