...
test('selectLanes: explicit flags win over the profile and discovery', () => {
  ...
  assert.deepEqual(r.sources, { ddl: 'flag', mappers: 'flag', javaSrc: 'flag', webSrc: 'none', openapi: 'none', har: 'none' });
...
test('selectLanes: with no flags the inputs come from the profile + discovery', () => {
  ...
  assert.deepEqual(r.sources, { ddl: 'profile', mappers: 'discovery', javaSrc: 'discovery', webSrc: 'none', openapi: 'none', har: 'none' });
